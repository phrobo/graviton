...
GList *graviton_introspection_interface_list_controls (GravitonIntrospectionControl *self, GError **error);
...
GravitonIntrospectionControl *graviton_introspection_interface_new_from_control (GravitonServiceInterface *control);
