...
#define GRAVITON_NODE_IO_STREAM_TYPE            ( \
    graviton_node_io_stream_get_type ())
#define GRAVITON_NODE_IO_STREAM(obj)            (G_TYPE_CHECK_INSTANCE_CAST (( \
                                                                               obj), \
                                                                             GRAVITON_NODE_IO_STREAM_TYPE, \
                                                                             GravitonNodeIOStream))
#define GRAVITON_NODE_IO_STREAM_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), \
                                                                          GRAVITON_NODE_IO_STREAM_TYPE, \
                                                                          GravitonNodeIOStreamClass))
#define IS_GRAVITON_NODE_IO_STREAM(obj)         (G_TYPE_CHECK_INSTANCE_TYPE (( \
                                                                               obj), \
                                                                             GRAVITON_NODE_IO_STREAM_TYPE))
#define IS_GRAVITON_NODE_IO_STREAM_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), \
                                                                          GRAVITON_NODE_IO_STREAM_TYPE))
#define GRAVITON_NODE_IO_STREAM_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), \
                                                                            GRAVITON_NODE_IO_STREAM_TYPE, \
                                                                            GravitonNodeIOStreamClass))
...
GravitonNodeIOStream *graviton_node_io_stream_new (SoupURI *uri,
                                                   SoupSession *session);
