...
#define GRAVITON_INTROSPECTION_INTERFACE_TYPE            ( \
    graviton_introspection_interface_get_type ())
#define GRAVITON_INTROSPECTION_INTERFACE(obj)            ( \
    G_TYPE_CHECK_INSTANCE_CAST ((obj), GRAVITON_INTROSPECTION_INTERFACE_TYPE, \
                                GravitonIntrospectionControl))
#define GRAVITON_INTROSPECTION_INTERFACE_CLASS(klass)    ( \
    G_TYPE_CHECK_CLASS_CAST ((klass), GRAVITON_INTROSPECTION_INTERFACE_TYPE, \
                             GravitonIntrospectionControlClass))
#define IS_GRAVITON_INTROSPECTION_INTERFACE(obj)         ( \
    G_TYPE_CHECK_INSTANCE_TYPE ((obj), GRAVITON_INTROSPECTION_INTERFACE_TYPE))
#define IS_GRAVITON_INTROSPECTION_INTERFACE_CLASS(klass) ( \
    G_TYPE_CHECK_CLASS_TYPE ((klass), GRAVITON_INTROSPECTION_INTERFACE_TYPE))
#define GRAVITON_INTROSPECTION_INTERFACE_GET_CLASS(obj)  ( \
    G_TYPE_INSTANCE_GET_CLASS ((obj), GRAVITON_INTROSPECTION_INTERFACE_TYPE, \
                               GravitonIntrospectionControlClass))
...
GList *graviton_introspection_interface_list_interfaces (
