...
#define GRAVITON_ROOT_SERVICE(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), \
                                                                           GRAVITON_ROOT_SERVICE_TYPE, \
                                                                           GravitonRootService))
#define GRAVITON_IS_ROOT_CONTROL(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), \
                                                                           GRAVITON_ROOT_SERVICE_TYPE))
#define GRAVITON_ROOT_SERVICE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), \
                                                                        GRAVITON_ROOT_SERVICE_TYPE, \
                                                                        GravitonRootServiceClass))
#define GRAVITON_IS_ROOT_CONTROL_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), \
                                                                        GRAVITON_ROOT_SERVICE_TYPE))
#define GRAVITON_PLUGIN_GET_MANAGER_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), \
                                                                            GRAVITON_ROOT_SERVICE_TYPE, \
                                                                            GravitonRootServiceClass))
